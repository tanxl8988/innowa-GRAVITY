...
+ (APKMWPhoto *)photoWithImage:(UIImage *)image {
	return [[APKMWPhoto alloc] initWithImage:image];
}

+ (APKMWPhoto *)photoWithURL:(NSURL *)url {
    return [[APKMWPhoto alloc] initWithURL:url];
}

+ (APKMWPhoto *)photoWithAsset:(PHAsset *)asset targetSize:(CGSize)targetSize {
    return [[APKMWPhoto alloc] initWithAsset:asset targetSize:targetSize];
}

+ (APKMWPhoto *)videoWithURL:(NSURL *)url {
    return [[APKMWPhoto alloc] initWithVideoURL:url];
}
